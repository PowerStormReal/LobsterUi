...
local Library = {
	Themes = {
    StealthTheme = {
    Main = Color3.fromHSV(0, 1, 0.2),         -- Deep Dark Red  
    Secondary = Color3.fromHSV(0, 1, 0.4),    -- Blood Red  
    Tertiary = Color3.fromHSV(200/360, 0.6, 1), -- Baby Blue Glow  

    StrongText = Color3.fromHSV(0, 0, 1),     -- White for readability  
    WeakText = Color3.fromHSV(200/360, 0.5, 0.7) -- Muted Baby Blue  
   },
		Legacy = {
...
function Library:create(options)
	...
	options = self:set_defaults({
		...
		Link = "https://github.com/PowerStormReal/LobsterUi"
	}, options)
